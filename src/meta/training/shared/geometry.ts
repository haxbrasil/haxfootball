...
import { BALL_RADIUS } from "@meta/legacy/stadium";
import { legacyMapMeasures } from "@meta/legacy/stadium";
...
export const TRAINING_LANE_GAP = legacyMapMeasures.YARD * 5;
...
const FIELD_TOP = legacyMapMeasures.INNER_FIELD.topLeft.y;
const FIELD_BOTTOM = legacyMapMeasures.INNER_FIELD.bottomRight.y;
