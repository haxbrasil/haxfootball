...
class HaxballCompatibilityRoom {
    ...
    public createJointFromObj(data: NodeHaxballJointFromObjParams): NodeHaxballJoint {
    ...
    public updateVertex(index: number, data: NodeHaxballUpdateVertexParams): void {
        this.room.updateVertex(index, data);
    }

    public updateSegment(index: number, data: NodeHaxballUpdateSegmentParams): void {
    ...
    public updatePlayer(playerId: number, data: NodeHaxballUpdatePlayerParams): void {
    ...
    public updateStadiumGeneral(data: NodeHaxballUpdateStadiumGeneralParams): void {
